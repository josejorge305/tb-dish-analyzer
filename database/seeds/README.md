...
- `seed_high_benefit_compounds.sql` requires migration `0006_ingredient_brain_cache.sql` to be applied first (creates `ingredients`, `ingredient_compound_yields`, `cooking_factors` tables).
